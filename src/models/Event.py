...
class Event:
    ...
    def __init__(
        ...
        # Defaults use None (not a class or a shared object) so every
        # instance gets its own independent Point/list — never a value
        # accidentally shared across all events created without an
        # explicit argument.
